function [Labels, BW_patch, Gray1_patch, Gray2_patch, Feature_vector] = create_pixel_features(image_path, tag_path, target)
...
candidate_centroid = [];
for i = 1:n
     if Candidate_properties(i).Area < 60        ||  Candidate_properties(i).Area > 400
...
for i=1:num_of_candidates
    ...
    Gray2_patch(i).image = create_patch(I_gray_2, x,y,patch_size);
